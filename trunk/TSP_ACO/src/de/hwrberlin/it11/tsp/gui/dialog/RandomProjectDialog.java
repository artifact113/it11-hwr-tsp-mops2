...
/**
 * Dialog zum generieren eines zuf‰lligen Projektes.
 * 
...
public class RandomProjectDialog extends AAntDialog {
	...
	public TSPData open() {
		...
		confirm.setTooltipText("Erstellt ein neues Projekt und schlieﬂt den Dialog.");
		...
		cancel.setTooltipText("Schleiﬂt den Dialog ohne ein Projekt zu erstellen.");
